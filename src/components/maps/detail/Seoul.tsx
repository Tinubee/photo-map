  ...
  return (
    <MapSvg xmlns="http://www.w3.org/2000/svg">
      ...
      <g filter="url(#dropshadow2)">
        <Text id="LCD11110" x="399" y="277">
          종로구
        </Text>
        <Text id="LCD11140" x="433" y="338">
          중구
        </Text>
        <Text id="LCD11170" x="407" y="395">
          용산구
        </Text>
        <Text id="LCD11200" x="505" y="356">
          성동구
        </Text>
        <Text id="LCD11215" x="577" y="365">
          광진구
        </Text>
        <Text id="LCD11230" x="528" y="294">
          동대문구
        </Text>
        <Text id="LCD11260" x="589" y="270">
          중랑구
        </Text>
        <Text id="LCD11290" x="466" y="258">
          성북구
        </Text>
        <Text id="LCD11305" x="459" y="181">
          강북구
        </Text>
        <Text id="LCD11320" x="494" y="125">
          도봉구
        </Text>
        <Text id="LCD11350" x="560" y="153">
          노원구
        </Text>
        <Text id="LCD11380" x="323" y="218">
          은평구
        </Text>
        <Text id="LCD11410" x="342" y="302">
          서대문구
        </Text>
        <Text id="LCD11440" x="293" y="339">
          마포구
        </Text>
        <Text id="LCD11470" x="209" y="421">
          양천구
        </Text>
        <Text id="LCD11500" x="156" y="334">
          강서구
        </Text>
        <Text id="LCD11530" x="199" y="470">
          구로구
        </Text>
        <Text id="LCD11545" x="279" y="537">
          금천구
        </Text>
        <Text id="LCD11560" x="295" y="413">
          영등포구
        </Text>
        <Text id="LCD11590" x="361" y="461">
          동작구
        </Text>
        <Text id="LCD11620" x="353" y="529">
          관악구
        </Text>
        <Text id="LCD11650" x="481" y="515">
          서초구
        </Text>
        <Text id="LCD11680" x="533" y="464">
          강남구
        </Text>
        <Text id="LCD11710" x="624" y="448">
          송파구
        </Text>
        <Text id="LCD11740" x="675" y="358">
          강동구
        </Text>
      </g>
    </MapSvg>
