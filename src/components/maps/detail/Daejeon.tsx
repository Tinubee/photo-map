...
function Daejeon() {
  return (
    <MapSvg xmlns="http://www.w3.org/2000/svg">
      ...
      <g>
        <Text id="LCD30110" x="552" y="551">
          동구
        </Text>
        <Text id="LCD30140" x="414" y="666">
          중구
        </Text>
        <Text id="LCD30170" x="272" y="667">
          서구
        </Text>
        <Text id="LCD30200" x="247" y="410">
          유성구
        </Text>
        <Text id="LCD30230" x="477" y="317">
          대덕구
        </Text>
      </g>
    </MapSvg>
